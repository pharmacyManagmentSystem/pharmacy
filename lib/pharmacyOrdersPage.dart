...
class _PharmacyOrdersPageState extends State<PharmacyOrdersPage> {
  ...
  void applyFilters() {
    ...
    // فلتر الحالة
    if (filterStatus != 'all') {
      temp = temp.where((order) => order['acceptStatus'] == filterStatus).toList();
    }
  ...
  Widget buildOrderCard(Map<String, dynamic> order) {
    ...
    final addressText = formatAddress(order['address'] as Map<String, dynamic>?);
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: [
          ListTile(title: const Text('Order ID'), subtitle: Text(order['orderId'] ?? '-')),
          ListTile(title: const Text('Email'), subtitle: Text(order['customerEmail'] ?? '-')),
          ListTile(title: const Text('Address'), subtitle: Text(addressText)),
          ListTile(title: const Text('Payment Method'), subtitle: Text(order['paymentMethod'] ?? '-')),
          ListTile(title: const Text('Total'), subtitle: Text(order['total']?.toString() ?? '-')),
          ListTile(title: const Text('Created At'), subtitle: Text(formattedDate)),
